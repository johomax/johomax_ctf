...
| Paintbot champion | **v132** (champion 09:56Z; spread_out upper seat on the v129 base) — rounds 3661-3663: 50.9 / 27.5 / 20.2 (mean 32.9) → **division rank 2 (50.92 vs codex 53.58)**; v133 (jackal + spread) submitted 10:26Z for a three-round trial. v130 (aggressive jackal recipe) posted **40.4** in round 3660 → division rank 4 (40.42; codex 53.6, lessandro 45.3, nancy 42.5). Queued: v133 uploaded = jackal recipe + spread_out (submit after v132's rounds); v131 uploaded = hold-4 recipe (unsubmitted). |

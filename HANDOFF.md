...
| Paintbot champion | **v132** (champion 09:56Z; spread_out upper seat on the v129 base) — round 3661: 50.9/seat, 5 wins, 39 kills → **division rank 2 (50.92 vs codex 53.58)**. v130 (aggressive jackal recipe) posted **40.4** in round 3660 → division rank 4 (40.42; codex 53.6, lessandro 45.3, nancy 42.5). Queued: v133 uploaded = jackal recipe + spread_out (submit after v132's rounds); v131 uploaded = hold-4 recipe (unsubmitted). |

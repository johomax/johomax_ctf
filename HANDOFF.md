...
| Paintbot champion | **v144** submitted 20:56Z 2026-09-04 (arm_up + hold-until-first-shrink + shelter; recipe research/s2_patches/recipes/v144-armup-hold-shelter.env) — the first version that ARMS under loot-at-start; v143 (unarmed since round 3736) benched. Judge by round sums (`analysis/s2_rounds.py`) vs the field medians in the 20:45Z ledger entry. |

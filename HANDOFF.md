...
| Paintbot champion | **v146 ACTIVE 22:06Z 2026-09-04** (hunt recipe: arm_up, hold until the first shrink, then edge_ride 140 + guarded jackal{700, afterKill, hpFloor 2}, crossfire late; 48 px adjacency guard; recipe research/s2_patches/recipes/v146-hunt-guard48.env). Local: same-duo 12 seeds ≈ 9.3M duo-score sum; mixed-duo meanSeat 49k vs 4k for v145. v146 round 3978: mean 480k/seat, a 10.08M episode (partner paintbot-huddle), 0 tk → standing 1,026,473 rank 1 at 22:19Z. Fallback v145 (five rounds: 3.4M/290k/15k/97k/3k). Judge v146 on ≥4 hosted rounds (analysis/s2_rounds.py --since 3978). |

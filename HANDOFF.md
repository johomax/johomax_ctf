...
| Paintbot champion | **v135** (champion 11:52Z; identical to v132: spread_out upper seat, hold 8, pact/never, edge_ride 220 — the best hosted recipe, 31.4 mean over 4 rounds). v134 (hold 6) trial 25.0/10.6/6.5/13.2. Next: v136 = v135 + S2_LOBBY_CHAT truce offer in the huddle (submit ~12:26Z). History: v132 (hold 8) 50.9/27.5/20.2/26.9 mean 31.4; v133 (jackal) 31.2/18.4/12.6/3.0 mean 16.3. Division rank 2 (50.92 vs codex 53.58). Local 16-game ranking vs starters: hold-6 0.938 > hold-5 0.875 > hold-8 0.812 > hold-4 0.714 > jackal 0.688. Recipes in research/s2_patches/recipes/. |

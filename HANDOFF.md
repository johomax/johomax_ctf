...
| Paintbot champion | **STOPPED 2026-09-11 22:34Z — v164 ACTIVE since 22:29Z 09-11 (= recipe v199: v195 + recalled edge_ride enterLead 80→160)**; standing 80,860 rank 3 (Lawrence 143,708, Aaron 127,851); GV18 cap rate since 4828: us 0.16 per 12, daveey/Aaron 0.31. Uploaded-unsubmitted: v165 = v200 bounty third, v166 = v201 weak-target lane. Resume steps in LEDGER 22:34Z 09-11.; GV18 queue after it: v200 (prefer weakened,isolated,bounty) → corrected weak-target lane rung (research/s2_glory_v18.md §5). Control = v195 (v163: rank 1 at 20:18Z with 0.55 caps/12 under GV17; one 2.1M leg in its first 5 GV18 rounds). Judge by analysis/s2_caps.py capped legs per 12 over ≥24 rounds. **v163 ACTIVE 22:51Z 09-09 – 22:2xZ 09-11 (= recipe v195) — RANK 1 at 2026-09-11 20:18Z (14,255 vs docxology 10,659, daveey-1 9,563, Andre von Auto 9,283)** — then GLORYVERSION 18 shipped at coworld 0.7.397 (round 4828, 09-11 ~21:20Z): ceiling 2,097,152, Tier IV/V claims x2.5/x3, tier-completion bonus x2-x4, placement x1.15/1.30/1.60. v163 banked a 2.1M leg in its first GV18 round → standing 102,438 rank 1 at 21:49Z. Judge by analysis/s2_caps.py (capped >=2,097,152 and big >=16,384 legs per 12). (= v192 [v191 + jackal above loot at 760, no lane_warden] + reciprocal pact with Lawrence|softmaxwell). Fallbacks in order: v192 (no pact) → v191 (v160 recipe, 0.48 caps/12). v162 (lane + pact) ACTIVE 22:31Z–22:5xZ was replaced before its window because research/s2_v161_window.md found the guarded lane likely inert/harmful. **v161 ACTIVE 20:20Z–22:3xZ**: 3 caps / 152 eps (0.24 per 12). Earlier: v161 submitted 20:18Z 09-09 (= recipe v193: v191 + jackal above loot + guarded longshot lane_warden; judge by capped legs per round via analysis/s2_caps.py over ≥12 rounds vs v160's 0.48 per 12)**. **v160 ACTIVE 19:20Z–20:2xZ**: 3 caps / 75 eps. (= v183 without the opening holdTrigger and with the guarded jackal recall at tick 760 — 'cap hunter'). WHY: the live v17 build (0.7.377, GameVersion 62) clamps every seat at 16,384 and losers bank it; the ladder now counts capped legs per round (metric: episodes with score == 16384). See research/s2_glory_v17_legs.md. **v158 ACTIVE 18:17Z–19:2xZ**: 1 capped leg in 60 eps. (= recipe v183 = the v154 baseline, re-uploaded because v156 was rejected: 0.86 K/ep over 336 overnight eps). GLORYVERSION 17 / GameVersion 62 / coworld 0.7.374+ live since ~round 4590: repriced tags, continuous survival credit, BR assists — standings all decayed to 100-240k (leader soft-codexter 237k; Jordan 113k rank 6 at 18:06Z). Engine clone /private/tmp/engine-main-v44 (server /tmp/johomax-ctf-server-runtime8, bot /tmp/e12-bot-v10). **Earlier: v156 ACTIVE 23:22Z 09-08 – 18:1xZ 09-09** (3 rounds: kills 7/15/10, sums 5k/1.70M/211k; standing 860,448 rank 5 at 00:05Z; docxology leads at 1.92M). Resume steps in LEDGER 00:06Z. v157 (= v187 enterLead 160) is uploaded, unsubmitted. (= recipe v186: v183 + supply_run guard requiring no tracked enemy or nearest_enemy > 650; judge after ≥6 rounds by kills/12 eps ≥ ~14, combat deaths under supply_run, jackpots). v155 (bounty, 22:11Z–23:2xZ) REJECTED: 0.96 K/ep, 3 wins in 75 eps. **v154 ACTIVE 20:36Z–22:xxZ — RANK 1 at 21:32Z (1,251,542)**; rounds 4489-4494 sums 86k/1.34M/4.98M/4.06M/592k/1.06M, 1.30 kills/ep (= recipe v183 research/s2_patches/recipes/v183-solo-margin240.env: v177 with recalled margins 240; one-variable test from research/s2_v153_hosted_analysis.md — judge by kills per 12 eps, zone-death share, jackpot rate; revert to v153's recipe if kills fall). Standing 20:32Z 1,011,080 rank 3. **v153 ACTIVE 2026-09-08 19:09Z–** (rounds 4480-4485: sums 398k/369k/224k/31k/469k/17.8M incl. our first 2^24 leg; 83 kills in 72 eps = 1.15/ep, leader level) = recipe v177 (research/s2_patches/recipes/v177-solo-hpfrac-fixed.env = v175 + supply_run correctly guarded hp_frac<0.3, jackal guard >=0.4). Hosted test queue under GLORYVERSION 17 (one variable each, ≥6 rounds; judge by kills/12 eps, win%, best legs; see research/s2_glory_v17.md): v158 = v183 baseline (live 18:17Z 09-09) → v159 = v190 reciprocal pact with Lawrence+softmaxwell (uploaded, both still declare pacts with us every call) → v188 no opening hold / v189 jackal recall at 420 (local screens) → v157 enterLead 160 (uploaded). REJECTED: v184 bounty (0.96 K/ep), v186 supply clearance (0.9 K/ep, 3% wins). Best known recipe: v183 (v154: 1.30 K/ep, 17% wins under v16). Shelved: v178 bloc pact (works, unhelpful), scatter openers, lane_warden longshot standoff. v152 (rounds 4478-4479, sums 2.9k/7.3k) was recipe v175 (research/s2_patches/recipes/v175-solo-nosupply.env = v170 minus supply_run: target_law hold to the first shrink + guarded loot + shelter; recall 900 hunt lane + guarded jackal; recall 1500 tight; NO partner refs, NO supply_run). v150 (= v170, benched 18:47Z) had supply_run guarded `hp_frac < 0.6` which passes at FULL HP because hp_frac = hp/(maxHp+3 shield) = 0.571, so seats sat in `supply_run:hold`. Correct hurt guard: hp_frac < 0.3 (recipe v177). Why: the league went SOLO on 09-05 (16 one-policy teams, spawn armed, no duo partner) and every `$PARTNER` recipe is rejected → the bot fell back to a bare edge_ride that never fires; v149 sat at rank 15 (202k) for days. Field medians 75-89k/round (apex, co-gas, Monet) with 16.8M capped legs. v150 rounds 4474-4476: sums ≈ 58k / 860k (top of round 4475, a 663,552 leg) / 25k vs v149's ≈1k. Ready alternatives: v151 (= v171 shelter), v174 (shelter + late jackal, best local win rate). |

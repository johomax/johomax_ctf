...
| Paintbot champion | **v145** active 21:19Z 2026-09-04 (arm_up + hold until the first shrink + shelter; pact/target_law overlays guarded by partner-not-adjacent so the seat never fires with the partner within 32 px; recipe research/s2_patches/recipes/v145-adjacency-guard.env). Local: tk 0, 6-13 kills/episode, duo scores up to 93k. v144 (same without the guard) took 12 tk in round 3971. Next: hunt variants v149b/v150/v151/v152 under local test. |

...
| Paintbot champion | **v145** active 21:19Z 2026-09-04 (arm_up + hold until the first shrink + shelter; pact/target_law guarded by partner-not-adjacent; recipe research/s2_patches/recipes/v145-adjacency-guard.env). First round 3973: mean 161k/seat, best 3.36M, 4 wins, 1 tk → **rank 1 (652,857) at 21:27Z**. Do not churn: standing is an EMA (k=0.05) of round sums; judge new variants on ≥12 local episodes (analysis/s2_local_glory.py) and rotate only on a clear win. |

...
| Paintbot champion | **v129** (09:00Z; v127 ladder + pact protect + never partner, baked via `ship.sh --env-file`). v127 rounds 31.6/5.0/0/0; v129 round 3656 4.8 with 12 partner kills — pact/never does not stop the stacked-duo mutual kill (engine corridor ignores a partner at zero distance). Division rank 5 (codex-t1 53.6, lessandro 45.3, nancy 42.5, Monet 36.8, us 31.6). |

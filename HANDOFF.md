...
| Paintbot champion | **v146 submitted 22:03Z 2026-09-04** (hunt recipe: arm_up, hold until the first shrink, then edge_ride 140 + guarded jackal{700, afterKill, hpFloor 2}, crossfire late; 48 px adjacency guard; recipe research/s2_patches/recipes/v146-hunt-guard48.env). Local: same-duo 12 seeds ≈ 9.3M duo-score sum; mixed-duo meanSeat 49k vs 4k for v145. Fallback v145 (rounds 3973-3976 sums 3.4M/290k/15k/97k, rank 1 at 578k). Judge v146 on ≥4 hosted rounds (analysis/s2_rounds.py --since 3977) against those sums. |

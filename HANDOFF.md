...
| Paintbot champion | **v130** (09:36Z; aggressive jackal recipe + pact/never). Rounds so far: v127 31.6/5.0/0/0, v129 4.8/9.2/0/9.9. Division rank 6 at 09:30Z (codex 53.6, lessandro 45.3, nancy 42.5, Monet 36.8, daveey 33.3, us 31.6). Candidates queued: v131h = hold-4 huddle recipe (+pact/never; locally 0.875 win share vs control 0.75 with a third of the partner kills), and the E9 `spread_out` duo-separation play (gate running). |

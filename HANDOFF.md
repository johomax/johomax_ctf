...
| Paintbot champion | **v145** active 21:19Z 2026-09-04 (arm_up + hold until the first shrink + shelter; overlays guarded by partner-not-adjacent 32 px; recipe v145-adjacency-guard.env). Hosted rounds 3973-3976: sums ≈ 3.4M / 290k / 15k / 97k, rank 1 (578k at 21:56Z). **v146 uploaded, unsubmitted** = hunt recipe (edge_ride 140 + guarded jackal from the first shrink, 48 px guard; v146-hunt-guard48.env): local same-duo 12 seeds ≈ 9.3M duo-score sum (v149: 232k), mixed-duo run in progress. Rotate to v146 only if its mixed run (analysis/s2_seat_glory.py episodes/s2-v155-mixed) beats v149-mixed (meanSeat 3,991, tk/seat 0.05) on tk and mean. |

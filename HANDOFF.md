...
| Paintbot champion | **v149 submitted 23:11Z 2026-09-04** = the v146 hunt recipe with guard-hardened supply_run (medkit_dist > 0, 0 < hp_frac < 0.67) and the stall-fixed arm_up build; recipe research/s2_patches/recipes/v149-hunt-guard-hardened.env. Why: coworld 0.7.328 (round 3983) let supply_run win the ladder at full HP (guard readings dead/zero) so every v146 seat camped at spawn with 0 damage. v146 had scored 10.08M and 35.8M episodes on 0.7.327 (standing peaked 2.77M). Candidates ready: v147 (grenade phase), v148 (loot + grenade phase) — re-harden their guards (v162 file) before shipping. |

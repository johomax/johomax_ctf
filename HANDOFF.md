...
| Paintbot champion | **v133** (champion 10:31Z; jackal recipe + spread_out upper seat) — round 3665: 31.2, 5 wins. v132 (spread on the v129 base) ran rounds 3661-3664: 50.9 / 27.5 / 20.2 / 26.9 (mean 31.4) → **division rank 2 (50.92 vs codex 53.58)**. Queued uploads: v134 = spread + hold 6 (locally 0.875 win share vs starters), v131 = hold-4 (unsubmitted). Rotation: three rounds per candidate, compare with analysis/s2_rounds.py, re-submit the best. |

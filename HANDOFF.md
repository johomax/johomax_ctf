...
| Paintbot champion | **v132** submitted 09:49Z (spread_out upper seat on the v129 base; qualifying → replaces v130). v130 (aggressive jackal recipe) posted **40.4** in round 3660 → division rank 4 (40.42; codex 53.6, lessandro 45.3, nancy 42.5). Queued: v134 uploaded = jackal recipe + spread_out (submit after v132's rounds); v131 uploaded = hold-4 recipe (unsubmitted). |

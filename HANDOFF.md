...
| Paintbot champion | **v143** (champion 22:54Z 2026-09-02; d1 longshot-ambush recipe research/s2_patches/recipes/v143-d1-longshot-ambush.env: guarded supply_run + guarded jackal{900, bothWeakened, hpFloor 2} before edge_ride 140/120/0.6, target_law prefer weakened/isolated/bounty, pact holdFire tick 10000, tick-160 recall drops the camper; local meanWin 137 max 443) — give it ≥4 rounds. Fallback v142 (edge_ride lower + camper upper; 9 rounds, best 257). Standing 363 (rank 2 behind richard 375). |

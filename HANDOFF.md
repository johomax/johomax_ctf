...
- Candidates: v171 (= v151 uploaded, unsubmitted): scatter + shelter 420 all game, posture 200 at 1200, tight 120 at 2000. v172: hold to zonePhase 2, prefer bounty, shelter → posture 1400 → tight 2200. Local batches: episodes/s3-v170, s3-v171, s3-v172 (judge with analysis/s2_seat_glory.py; the cautious starter is the local bar at ~111k meanSeat).

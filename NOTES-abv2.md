...
| `CTF_LEVER_ODDS` | v29 | 80 | -0.1387 | [-0.2180,-0.0605] | -0.225 [-0.425,-0.000] | +1 [-11,+14] | level (CI crosses zero) |
| `CTF_LEVER_HOLDEVEN` | v34 | 80 | +0.1087 | [+0.0299,+0.1893] | +0.200 [-0.025,+0.400] | -4 [-13,+5] | level (CI crosses zero) |
